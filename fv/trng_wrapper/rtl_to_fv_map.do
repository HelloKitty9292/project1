...
# Generated on: Wed Feb 25 20:46:35 EST 2026 (Thu Feb 26 01:46:35 UTC 2026)
...
set logfile fv/trng_wrapper/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/trng_wrapper -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/afs/ece/support/cds/share/image/usr/cds/genus-21.18/tools.lnx86"
set CDN_SYNTH_ROOT      "/afs/ece/support/cds/share/image/usr/cds/genus-21.18/tools.lnx86"
set env(CW_DIR) "/afs/ece/support/cds/share/image/usr/cds/genus-21.18/tools.lnx86/lib/chipware"
set CW_DIR      "/afs/ece/support/cds/share/image/usr/cds/genus-21.18/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /afs/ece/support/cds/share/image/usr/cds/genus-21.18/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/afs/ece/support/cds/share/image/usr/cds/genus-21.18/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/afs/ece/support/cds/share/image/usr/cds/genus-21.18/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/afs/ece/support/cds/share/image/usr/cds/genus-21.18/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/afs/ece/support/cds/share/image/usr/cds/genus-21.18/tools.lnx86/lib/chipware/sim"
}
...
add_search_path ../lib/ ../lib/ ../lib/ -library -both
read_library -liberty -both \
    /afs/ece.cmu.edu/usr/hsuanjul/Private/18632/project1/../lib/asap7sc7p5t_AO_LVT_TT_nldm_211120.lib \
    /afs/ece.cmu.edu/usr/hsuanjul/Private/18632/project1/../lib/asap7sc7p5t_INVBUF_LVT_TT_nldm_220122.lib \
    /afs/ece.cmu.edu/usr/hsuanjul/Private/18632/project1/../lib/asap7sc7p5t_OA_LVT_TT_nldm_211120.lib \
    /afs/ece.cmu.edu/usr/hsuanjul/Private/18632/project1/../lib/asap7sc7p5t_SEQ_LVT_TT_nldm_220123.lib \
    /afs/ece.cmu.edu/usr/hsuanjul/Private/18632/project1/../lib/asap7sc7p5t_SIMPLE_LVT_TT_nldm_211120.lib
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 library.sv t1_frequency.sv t2_frequency.sv t3_runs.sv t4_blockrun.sv t5_rank.sv t7_template_non_ovelap.sv t8_template_overlap.sv t10_taps.sv t13_chi2.sv trng_wrapper.sv
elaborate_design -golden -root {trng_wrapper} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/trng_wrapper/fv_map.v.gz
elaborate_design -revised -root {trng_wrapper}
...
#add_name_alias fv/trng_wrapper/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.trng_wrapper.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.trng_wrapper.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.trng_wrapper.rtl.fv_map.rpt
